...
public class AdmPrikazPredstavaSvih extends JPanel {
	...
	public JButton novaPred = new JButton("Kreiraj novu");
	...
	public AdmPrikazPredstavaSvih() throws ParseException {
		...
		novaPred.setBounds(343, 25, 154, 31);
		novaPred.setForeground(tamnoZelena);
		novaPred.setBackground(tirkizna);
		novaPred.setFont(new Font("Ubuntu Mono", Font.PLAIN, 20));
		panel2.add(novaPred);
		...
		for (int i = 0; i < Cuvanje.Predstave.size(); i++) {
			...
			modelPred.addRow(new Object[] { Cuvanje.Predstave.get(i).getNazivPredstave(),
