...
public class AdmUnosNovePredstave extends JPanel {
	...
	public JButton sacuvajPred = new JButton("SAČUVAJ IZMENE");
	...
	public JLabel izvestaj = new JLabel(new ImageIcon(AdmUnosNovePredstave.class.getResource("/images/izvestaj.png")));
	...
	public AdmUnosNovePredstave() {
		...
		ocistiFormu.setBounds(343, 25, 154, 31);
		...
		sacuvajPred.setBounds(300, 580, 180, 30);
		sacuvajPred.setForeground(tamnoZelena);
		sacuvajPred.setBackground(tirkizna);
		sacuvajPred.setFont(new Font("Ubuntu Mono", Font.PLAIN, 20));
		panel2.add(sacuvajPred);
		...
		JPanel spojeno = new JPanel();
		spojeno.setBounds(0, 0, 1200, 720);
		spojeno.setBackground(podloga);
		spojeno.setBorder(new EmptyBorder(5, 5, 5, 5));
		spojeno.setLayout(null);
		spojeno.add(panel1);
		spojeno.add(panel2);

		this.add(spojeno, BorderLayout.CENTER);
